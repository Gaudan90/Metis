...
class _MachineListState extends State<MachineList> {
  ...
  final Map<String, List<Machine>> _categories = {
    'Chocolate Processing': [
      Machine(name: 'LEGEND', productionYear: '2022', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'TRUFFLE', productionYear: '2021', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'MASTER', productionYear: '2023', imageUrl: '/api/placeholder/100/100'),
    ],
    'Coating Lines': [
      Machine(name: 'COATING LINE 20', productionYear: '2020', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'COATING LINE 40', productionYear: '2021', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'COATING LINE 60', productionYear: '2022', imageUrl: '/api/placeholder/100/100'),
    ],
    'Tempering Machines': [
      Machine(name: 'TOP EX', productionYear: '2023', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'PLUS EX', productionYear: '2022', imageUrl: '/api/placeholder/100/100'),
      Machine(name: 'TWIN EX', productionYear: '2021', imageUrl: '/api/placeholder/100/100'),
    ],
  };

                  ...
                  RichText(
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(text: 'ScanSelmi', style: TextStyle(color: Color(0xFF304A78))),
                      ],
                    ),
                  ),
                  SizedBox(height: 16),
  ...
  void _handlePasswordReset() {
    if (_emailController.text.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Password reset instructions sent to ${_emailController.text}')),
      );
    }
  }
